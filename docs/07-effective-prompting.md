...
> **Preventing Premature Stops**: Multi-phase workflows are prone to Claude stopping between phases or within a phase before completion. To prevent this, use the Ralf Loop pattern with phase-specific validation hooks. See [Part 25: The Ralf Loop - Preventing Premature Stops](25-ralf-loop.md) for implementation details.

...
## Setup
[How to install dependencies, build, etc.]
...
## Goals
Work on the following goals. Multiple agents may be working in parallel — use the task coordination protocol below to avoid conflicts.
